...
export const verticalMenuItems = [
    new Menu (1, 'Dashboard', '/pages/dashboard', null, 'tachometer', null, false, 0),
    new Menu (10, 'Testing', '/pages/testing', null, 'fa-free-code-camp', null, false, 0),
    new Menu (40, 'File manager', '/pages/documentLibrary', null, 'fa-folder-open', null, false, 0),
    new Menu (50, 'File manager2', '/pages/filemanager', null, 'fa-folder-open', null, false, 0),
    new Menu (200, 'External Link', null, 'https://devproducts.alfresco.com/components/alfresco-js-api', 'external-link', '_blank', false, 0)
];
